...
@Component({
  selector: 'app-applicant-skill-education',
  templateUrl: './applicant-skill-education.component.html',
  styleUrls: ['./applicant-skill-education.component.css'],
})
export class ApplicantSkillEducationComponent {
  seeker_model: Seeker = new Seeker();
  seeker_skill: SeekerSkills = new SeekerSkills();
  seeker_language: SeekerLanguage = new SeekerLanguage();
  seeker_experience: SeekerExperience = new SeekerExperience();
  education_details: EducationDetails = new EducationDetails();
  ...
  ngOnInit(): void {
    ...
    this.getEducationDetailsInformations(sessionStorage.getItem('login_id'));
  }
  ...
  education_informations:any;
  getEducationDetailsInformations(user:any){
    this.seeker_service.list_of_education_details_for_this_user(user).subscribe((response:any) =>{
      this.education_informations = response;
    });
  }
  ...
  check_if_details_exist() {
    let seeker_id = '';
    this.registrationService
      .getSpecificUserInformation(sessionStorage.getItem('login_id'))
      .subscribe((output: any) => {
        this.seeker_service
  ...
  saveDetails() {
    this.registrationService.getSpecificUserInformation(sessionStorage.getItem('login_id'))
    .subscribe((output: any) => {
      this.seeker_model.user_information_id = output.user_information_id;

      this.seeker_service.saveSeeker(this.seeker_model).subscribe((resp: any) => {
        const seeker_id = resp.seeker_id;
        this.seeker_skill.seeker_id = seeker_id;
        this.seeker_experience.seeker_id = seeker_id;
        this.education_details.seeker_id = seeker_id;
        this.education_details.user_id = sessionStorage.getItem('login_id');
        this.seeker_service
          .saveEducationDetails(this.education_details)
          .subscribe((resp: any) => {});
        this.seeker_service
          .saveSeekerSkillls(this.seeker_skill)
          .subscribe((resp: any) => {});
        this.seeker_service
          .saveSeekerExperience(this.seeker_experience)
          .subscribe((resp: any) => {});
        for (const element of this.seeker_language.language) {
          this.seeker_language.seeker_id = seeker_id;
          this.seeker_language.language = element;
          this.seeker_service
            .saveSeekerlanguage(this.seeker_language)
            .subscribe((resp: any) => {});
        }
        this.seeker_model = new Seeker();
        this.seeker_skill = new SeekerSkills();
        this.seeker_experience = new SeekerExperience();
        this.seeker_language = new SeekerLanguage();
  ...
  getYears() {
    ...
    for (let year = startYear; year <= currentYear; year++) {
      this.year_data.push(year);
    }
    this.year_data.sort((a, b) => b - a);
  }
  ...
  success_alert() {
    ...
    Toast.fire({
      icon: 'success',
      title: 'Your information has been added successfully',
    });
  }
  ...
  error_alert() {
    ...
    Toast.fire({
      icon: 'error',
      title: 'Information was not added successfully',
    });
  }

  gotToAddMoreEducationDetails(){
    this.router.navigate(['job_portal/add_more_education']);
  }

  goToModifyMyInformation(){
    this.router.navigate(['job_portal/seeker_modify_data']); 
  }
}
