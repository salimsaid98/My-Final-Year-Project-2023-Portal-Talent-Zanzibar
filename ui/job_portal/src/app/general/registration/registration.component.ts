...
import { SeekerModel } from 'src/app/models/seeker-model';
...
export class RegistrationComponent {
  ...
  constructor(private login_service:LoginServicesService,private route:Router,private user_registration_service:RegistrationServicesService){}

  Selectfile: File = null!;

  seeker_model: SeekerModel = new SeekerModel();
  ...
  saveSeeker(){
    this.loading = true;
    this.login_model.role = "Seeker";
    this.login_model.username = this.seeker_model.email;
    this.seeker_model.registration_date = new Date();

    this.login_service.user_registrations(this.login_model).subscribe((output:any)=>{
      this.seeker_model.user_id = output.user_id;
      const form1 = new FormData();
      form1.append('imageFile', this.Selectfile, this.Selectfile.name);
      this.user_registration_service.saveUser_Information(this.seeker_model).subscribe((output_2:any)=>{
        this.user_registration_service.saveUserLogo(form1,output.user_id).subscribe((resp:any)=>{});
        this.loading = false;
