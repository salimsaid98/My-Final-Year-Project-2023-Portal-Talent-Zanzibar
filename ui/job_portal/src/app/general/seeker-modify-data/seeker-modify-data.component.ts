...
@Component({
  selector: 'app-seeker-modify-data',
  templateUrl: './seeker-modify-data.component.html',
  styleUrls: ['./seeker-modify-data.component.css']
})
export class SeekerModifyDataComponent {
  constructor(
  ...
  modifySeeker(){
    ...
    this.seeker_model.user_id = sessionStorage.getItem('login_id');
    this.registrationService.updateUserInformation(this.user_information_id,this.seeker_model).subscribe((data:any)=>{
      this.ngOnInit();
