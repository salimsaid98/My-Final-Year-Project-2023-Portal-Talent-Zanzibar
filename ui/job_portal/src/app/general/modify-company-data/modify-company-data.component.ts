...
@Component({
  selector: 'app-modify-company-data',
  templateUrl: './modify-company-data.component.html',
  styleUrls: ['./modify-company-data.component.css']
})
export class ModifyCompanyDataComponent {
  constructor(
 ...
 baseURLFunc(img_url:any){
   return 'data:image/png;base64,'+img_url;
 }
 ...
 gotoEditMyProfile(){
  this.router.navigate(['job_portal/my_profile_company']);
}
 ...
 modifyData(){
  ...
  this.company_service.updateCompanyInformation(this.company_id,this.company_model).subscribe((resp:any)=>{
    this.ngOnInit();
    ...
    Toast.fire({
      icon: 'success',
      title: 'Company has been modified successfully',
    });
  });
 }
