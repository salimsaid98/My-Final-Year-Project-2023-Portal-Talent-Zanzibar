...
@Component({
  selector: 'app-seeker-informations',
  templateUrl: './seeker-informations.component.html',
  styleUrls: ['./seeker-informations.component.css']
})
export class SeekerInformationsComponent {
  ...
  ngOnInit(): void {
    ...
    this.check_if_details_exist(this.user_id);
    this.getEducationDetailsInformations(this.user_id);
  }
  ...
  check_if_details_exist(user_id:any) {
    let seeker_id = '';
    this.registrationService
      .getSpecificUserInformation(user_id)
      .subscribe((output: any) => {
